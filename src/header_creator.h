...
struct shm_remove
{
	shm_remove() { boost::interprocess::shared_memory_object::remove("MEMORY_REGION"); }
	~shm_remove(){ boost::interprocess::shared_memory_object::remove("MEMORY_REGION"); }
};
...
private:
	...
	explicit SharedMemoryCreator() : remover{},shm{boost::interprocess::create_only, "MEMORY_REGION", boost::interprocess::read_write}{
		shm.truncate(5880280);
